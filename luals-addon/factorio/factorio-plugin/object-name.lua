...
local function replace(_, text, diffs)
  ...
  do
    ...
    local line_start = util.get_line_start(s_obj_name)
    local preceding_text = string.sub(text, line_start, s_obj_name - 1)
    ...
    preceding_text = string.sub(text, line_start, p_front - 1)
